...
module.exports.easing = __webpack_require__(131);
module.exports.canvas = __webpack_require__(132);
module.exports.options = __webpack_require__(133);
...
module.exports = {};
module.exports.Arc = __webpack_require__(139);
module.exports.Line = __webpack_require__(140);
module.exports.Point = __webpack_require__(141);
module.exports.Rectangle = __webpack_require__(142);
...
var string = __webpack_require__(137);
...
var helpers = __webpack_require__(1);
var basic = __webpack_require__(143);
var dom = __webpack_require__(144);
...
var charts_1 = __webpack_require__(128);
$(document).ready(function () {
    var rowingStatLineChart = new charts_1.RowingStatLineChart('');
});
...
var RowingStatLineChart = (function () {
    function RowingStatLineChart(selector) {
        $('.js-data-chart').each(function (index, chart) {
            var ctx = chart.getContext('2d');
            var strokes = $(chart).data('strokes');
            var timeAxisTicks = ['0:00'];
            var firstStroke = strokes[0];
            var chartStrokesData = [{
                    x: 0,
                    y: '0'
                }];
            var measurementSamplePointSeconds = 10;
            strokes.forEach(function (strokeData, index) {
                var stroke = strokeData - firstStroke;
                if (stroke >= (measurementSamplePointSeconds * 1000)) {
                    var ratio = stroke / (measurementSamplePointSeconds * 1000);
                    chartStrokesData.push({
                        x: stroke,
                        y: ((index * (10 / 4.805)) / ratio).toFixed(2)
                    });
                    timeAxisTicks.push(measurementSamplePointSeconds % 60 === 0 ? measurementSamplePointSeconds / 60 + ':00' : Math.floor(measurementSamplePointSeconds / 60) + ':' + measurementSamplePointSeconds % 60);
                    measurementSamplePointSeconds += 10;
                }
            });
    ...
    return RowingStatLineChart;
}());
exports.RowingStatLineChart = RowingStatLineChart;
...
var conversions = __webpack_require__(136);
